...
Route::middleware('auth')->group(function () {
    Route::controller(HomeController::class)->group(function(){
        ...
        //Route::get('/reports', [HomeController::class, 'InitReports'])->name('InitReports')->middleware('App\Http\Middleware\NoCacheMiddleware');
        ...
        //Route::get('/dashboard', [HomeController::class, 'dashboard'])->name('dashboard')->middleware('App\Http\Middleware\NoCacheMiddleware');
